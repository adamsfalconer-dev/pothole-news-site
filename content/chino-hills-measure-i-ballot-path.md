...
**Why it matters:** Measure I is where a chunk of Chino Hills' street money comes from. By SBCTA's own account, the half-cent tax has run since 1990, and its 2004 extension — which the authority says passed with over 80% approval — expires in 2040; the new extension would continue the stream beyond that. A recommendation is not placement, and placement is not passage: three separate gates, and only the first has been cleared. And this measure would share a Chino Hills ballot with the city's own proposed 1-cent sales tax, if the council advances that Tuesday — two tax questions, one November.
